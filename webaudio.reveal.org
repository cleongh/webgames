...
[[https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API][Web
Audio]] es una forma de reproducir audio en el navegador a bajo nivel
...
Para reproducir una pista de audio en un archivo estándar, usar una
etiqueta =<audio>= es generalmente mucho más razonable
...
La información de la "onda" se enruta entre los nodos, de forma que
encadenamos procesos
...
Ejemplo de oscilador con nodos
