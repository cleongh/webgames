...
[[https://docs.phaser.io/api-documentation/event/sound-events][eventos
...
Los
/[[https://docs.phaser.io/api-documentation/class/sound-basesoundmanager#addaudiosprite][audio sprites]]/ son un sistema en el que un solo archivo de audio contiene
...
[[https://phaser.io/examples/v3.85.0/audio/view/load-audio-sprite][Aquí hay un ejemplo de este tipo de audio]]
