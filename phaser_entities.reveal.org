...
:CUSTOM_ID: cámara
:END:
#+caption: La escena, la cámara y entidades más allá de los límites de
la cámara
[[file:world.svg]]
...
[[https://newdocs.phaser.io/docs/3.55.2/Phaser.Cameras.Scene2D.Camera][cámaras]]

#+REVEAL: split

#+caption: El mundo, la cámara y entidades más allá de los límites de la
cámara
[[file:world-and-camera.svg]]

#+REVEAL: split

Al iniciar, se crea una cámara, a la que podemos acceder a través del
atributo
[[https://newdocs.phaser.io/docs/3.55.2/Phaser.Scene#cameras][=cameras.main=]]
de la escena:
...
Podéis ver un [[https://codepen.io/gjimenezucm/pen/jOmybNe][ejemplo en
Phaser 3]] en el que las entidades se agrupan según una jerarquía
